...
// Titres FR par (type, key) — certaines keys partagées ont un libellé différent selon le type
const TITLES: Record<'metier' | 'fiches_profils' | 'pays', Record<string, string>> = {
  metier: {
    comment_declarer: 'Comment déclarer',
    temps_estime: 'Temps estimé',
    specificites: 'Spécificités de la situation',
    revenus: 'Revenus à déclarer',
    charges: 'Charges déductibles',
    credits_reductions: 'Crédits & Réductions',
    vigilance: 'Points de vigilance',
    cas_pratiques: 'Cas pratiques',
  },
  fiches_profils: {
    comment_declarer: 'Comment bien déclarer',
    pieces_a_rassembler: 'Pièces à rassembler',
    temps_estime: 'Temps estimé',
    specificites: 'Spécificités du profil',
    revenus: 'Revenus à déclarer',
    charges: 'Charges à déclarer',
    credits_reductions: "Réductions d'impôt fréquentes",
    vigilance: 'Points de vigilance',
    cas_pratiques: 'Cas pratiques',
  },
  pays: {
    profil_origine: "Profil du contribuable d'origine",
    residence_fiscale: 'Résidence fiscale',
    obligations_fiscales: 'Obligations fiscales en France',
    convention_fiscale: 'Convention fiscale',
    comment_declarer: 'Comment déclarer ses revenus',
    droits_avantages: 'Droits et avantages fiscaux',
    vigilance: 'Points de vigilance',
    checklist_finale: 'Checklist finale',
  },
};
