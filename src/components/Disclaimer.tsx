 ...
 * Impôts Facile = formation / information pédagogique, PAS de conseil fiscal individualisé.
 */
    ...
    <div className="mt-12 rounded-lg border border-border bg-muted/40 p-4 text-xs leading-relaxed text-muted-foreground">
      <div className="flex gap-2">
        ...
        <p>
          ...
          Impôts Facile est une plateforme de formation et d'information sur la fiscalité.
          Les contenus, simulations, recommandations et fiches proposés ont une vocation
          éducative et ne constituent ni un conseil fiscal personnalisé, ni une prestation
          réglementée. Pour toute décision engageante, consultez un professionnel agréé
          (avocat fiscaliste, expert-comptable) ou rendez-vous sur{' '}
          <a
