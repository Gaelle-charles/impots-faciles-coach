...
const modules = [
  ...
  { num: 6, Icon: Hourglass, title: 'Bientôt disponible', desc: 'Nouveau module en cours de préparation.', available: false },
...
const pricingCards = [
  ...
  },
  {
    ...
    price: '79 €',
    period: '/an',
    features: ['Tout Starter inclus', 'Fiches par profil contribuable', 'Fiches par métier', 'Coaching pédagogique personnalisé'],
  ...
  },
  {
    ...
    price: '119 €',
    period: '/an',
    features: ['Tout Expert inclus', 'Coaching pédagogique avancé', '5 webinaires exclusifs'],
    btnVariant: 'outline' as const,
